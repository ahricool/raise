...
/** 默认同源 API；仅当显式设置 VITE_API_URL 时覆盖。 */
...
const runtimePackageVersion =
  typeof __APP_PACKAGE_VERSION__ === 'string' ? __APP_PACKAGE_VERSION__.trim() : PLACEHOLDER_WEB_VERSION
const runtimeBuildTime = typeof __APP_BUILD_TIME__ === 'string' ? __APP_BUILD_TIME__.trim() : ''
