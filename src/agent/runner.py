...
try:
    ...
    _logging.getLogger(__name__).debug("persist_llm_usage not available in this environment; skipping usage persistence")

    def _persist_usage(*args, **kwargs) -> None:  # type: ignore[misc]
        """No-op stub when the host storage layer lacks persist_llm_usage."""
